...
namespace ProjectCore.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public List<ProjectCore.Logica.Models.ViewModel.ProjectsIndexViewModel> listProjects;
        ...
        public IActionResult Delete(int? id)
        {
            ...
            return RedirectToAction("Index");
            //puedo redireccionar a acciones de otros controladores ("index","projects")
